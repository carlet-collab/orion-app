...
const s = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16, borderBottomWidth: 1, borderBottomColor: '#E8E8E8', backgroundColor: '#fff' },
  backBtn: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center' },
  backTxt: { fontSize: 22, color: '#1A1A1A' },
  headerTitle: { fontSize: 12, fontWeight: '700', color: '#1A1A1A', letterSpacing: 3 },
  count: { fontSize: 12, color: '#AEAEB2', fontWeight: '600', letterSpacing: 1, marginBottom: 12 },
  routeCard: { backgroundColor: '#fff', borderRadius: 16, padding: 18, marginBottom: 12, borderWidth: 1, borderColor: '#E8E8E8' },
  ...
  routeCity: { fontSize: 15, fontWeight: '700', color: '#1A1A1A', flex: 1 },
  routeMeta: { flexDirection: 'row', gap: 16, marginBottom: 12 },
  metaTxt: { fontSize: 11, color: '#AEAEB2' },
  routeFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: '#E8E8E8', paddingTop: 12 },
  routeDate: { fontSize: 11, color: '#AEAEB2' },
  routeActions: { flexDirection: 'row', gap: 8 },
  openBtn: { backgroundColor: '#1A1A1A', borderRadius: 8, paddingVertical: 7, paddingHorizontal: 14 },
  openBtnTxt: { color: '#fff', fontSize: 10, fontWeight: '700', letterSpacing: 1 },
  deleteBtn: { width: 34, height: 34, borderRadius: 8, borderWidth: 1, borderColor: '#E8E8E8', alignItems: 'center', justifyContent: 'center' },
  deleteBtnTxt: { fontSize: 14 },
  emptyTitle: { fontSize: 18, fontWeight: '700', color: '#1A1A1A', marginBottom: 8, textAlign: 'center' },
  emptyBody: { fontSize: 13, color: '#6E6E73', textAlign: 'center', lineHeight: 20, marginBottom: 24 },
  ctaBtn: { backgroundColor: '#1A1A1A', borderRadius: 12, paddingVertical: 13, paddingHorizontal: 28 },
